        ...
        {/* <Section id="about" headerText="About" topic={sectionTopic.About}>
          <Article>
            <div className={styles.flex}>
              <div>
                <p>
                  Over the past two decades, I have worked on a wide range of projects, from smaller startups to large enterprises. Always keeping the customer experiance and value at the forefront.
                </p>
                <p className={styles.highlighted}>
                  As a .NET Developer: I have developed numerous web applications and enterprise software solutions mainly using the .NET framework. Together with architectures and patterns such as Domain Driven Design, Microservices, Event driven architecture, Test Driven Development and Behaviour Driven Development.
                  <code className={styles.code}>C#, Web API, Microservices, DDD, EventSource</code>
                </p>
                <p>
                  As a Technical Lead and Dev Lead: I spearheaded the development of cloud-based applications on AWS and Azure, helping the team delivering high-performance solutions that scaled effectively.
                  <code>AWS, Azure, DevOps, Agile, Communication, leadership</code>
                </p>
              </div>
            </div>
          </Article>
